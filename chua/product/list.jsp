							...
							<div class="sidebar_widget filterBox filter-widget">
								...
								<form action="">
									...
									<button formaction="/product/list/price/300-900"
										class="btn mb-2 btn--secondary">Từ 300K - 500k</button>
										...
										<div class="col-6 col-sm-6 col-md-4 col-lg-4 item">
											...
											<div class="product-image">
												...
												<a href="/product/detail/${p.product.id}"> <!-- image -->
													<img class="product primary blur-up lazyload"  được sử dụng để hiển thị một hình ảnh sản phẩm
													...
													data-src="/images/product/${p.images[1]}" //xac dinh duong dan 
