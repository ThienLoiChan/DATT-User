			...
			<div class="row">
				<div class="col-md-3">
					<div class="language-dropdown">
						<span class="language-dd">Viêt Nam</span>
						
					</div>
					<p class="phone-no">
						<i class="anm anm-phone-s"></i> +035522222
					</p>
				</div>
		...
		<div class="container-fluid">
			<div class="row align-items-center">
				...
				<div class="logo col-md-2 col-lg-2 d-none d-lg-block">
					<a style="text-decoration: none;" href="/"><h1 style="font-size:20px; font-weight: 600; color: rgb(39, 39, 39);	">
					Áo Quần Bóng Đá Shop
					</h1> </a>
